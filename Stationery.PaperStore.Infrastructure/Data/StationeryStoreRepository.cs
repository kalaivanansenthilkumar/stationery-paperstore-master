...
using Stationery.PaperStore.Core.Specifications;
using Microsoft.EntityFrameworkCore;

namespace Stationery.PaperStore.Infrastructure.Data
{
    public class StationeryStoreRepository<T> : IEcommerceRepository<T> where T : BaseEntity
    {
        private readonly StationeryStoreContext _context;
        public StationeryStoreRepository(StationeryStoreContext context)
        {
            _context = context;
        }
